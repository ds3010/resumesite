...
function App() {
  ...
  const options = [
    ...
    },
    {
      ...
      id: 4,
      items: [
        { description: "HTML 5", imageUrl: "images/html.png" },
        { description: "CSS3", imageUrl: "images/css.png" },
        {
          description: "Javascript",
          imageUrl: "images/javascript.svg",
        },
        { description: "React JS", imageUrl: "images/react.png" },
        { description: "Python", imageUrl: "images/python.png" },
        { description: "CCNA Certified", imageUrl: "images/ccna.jpg" },
        { description: "CCNP Certified", imageUrl: "images/ccnp.png" },
        { description: "MySQL", imageUrl: "images/sql.png" },
        {
          description: "Bootstrap",
          imageUrl: "images/bootstrap-logo-shadow.png",
        },
        {
          description: "Angular",
